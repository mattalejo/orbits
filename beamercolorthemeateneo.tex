...
\definecolor{blue}{rgb}{0,0.66,0.586}
\definecolor{red}{rgb}{0.688,0,0}

\setbeamercolor{section in toc}{fg=black,bg=white}
\setbeamercolor{alerted text}{fg=blue!80!gray}
\setbeamercolor*{palette primary}{fg=blue!60!black,bg=gray!30!white}
\setbeamercolor*{palette secondary}{fg=blue!70!black,bg=gray!15!white}
